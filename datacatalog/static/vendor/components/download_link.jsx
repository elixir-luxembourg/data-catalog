        ...
        return (
            <>
                        ...
                        <div className="w-full max-w-lg overflow-hidden rounded bg-white shadow-lg">
                            ...
                            <div className="flex justify-end border-t border-gray-200 bg-gray-50 px-5 py-3">
                                <button onClick={this.closeModal.bind(this)}
                                    className="inline-flex items-center justify-center gap-2 border border-blue-900 bg-white px-4 py-2 text-sm font-semibold text-blue-900 transition-colors hover:bg-blue-900 hover:text-white focus:outline-none focus:ring-2 focus:ring-blue-900 focus:ring-offset-2">
                                    Close
                                </button>
                            </div>
                        </div>
                ...
                <a href="#" onClick={this.onDownloadClicked.bind(this)}
                    className="flex w-full items-center justify-center gap-2 bg-blue-900 px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-900 focus:ring-offset-2">
